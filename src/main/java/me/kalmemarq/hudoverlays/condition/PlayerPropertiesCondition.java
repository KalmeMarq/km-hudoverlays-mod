...
public class PlayerPropertiesCondition implements IOverlayCondition {
    ...
    public static final class PlayerProperty {
        ...
        static {
            ...
            register("is_wet", PlayerEntity::isWet);
            register("is_swimming", PlayerEntity::isSwimming);
            register("is_crawling", PlayerEntity::isCrawling);
            register("is_sleeping", PlayerEntity::isSleeping);
        }
